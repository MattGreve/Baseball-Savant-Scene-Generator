...
Sorts user input data from baseball savant and turns it into a 3D bar graph. It will support data input for hitting or pitching. It will sort data input from a copy paste automatically and then build the scene automatically.
